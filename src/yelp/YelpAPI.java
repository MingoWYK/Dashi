...
public class YelpAPI {
	...
	private static final String CLIENT_ID = "eOOC_FDlZdB07Wal2GfkEg";
	private static final String CLIENT_SECRET = "Ir6y1N1hcZZudFFbRP5iQZhaOg4VNxVsaJFqbdMEUVVnXTjF8LAvcACG8FYPWiiJ";
	...
	public String searchForBusinessesByLocation(double lat, double lon) {
		...
		String query = String.format("term=%s&latitude=%s&longitude=%s&limit=%s", DEFAULT_TERM, latitude, longitude,
				SEARCH_LIMIT);
